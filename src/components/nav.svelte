...
<nav class="flex bg-gray-900 text-white w-full justify-between px-6 py-4 items-center">
    ...
    <div class="flex gap-4 hover:text-gray-500">
    ...
    <div class="flex gap-4 items-center">
        <button class="relative inline-flex items-center justify-center p-0.5 mr-2 overflow-hidden text-sm font-medium text-white rounded-xl group bg-gradient-to-br from-teal-300 to-lime-300 hover:from-teal-300 hover:to-lime-300">
